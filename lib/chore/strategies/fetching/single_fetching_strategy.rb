module Chore
  module Strategy
    module Fetching
      ...
      # Fetching strategy for requesting batches of work in a linear fashion. Ideally used for running
      # a single Chore job locally in a development environment where performance or throughput may not matter.
      # <tt>SingleFetchingStrategy</tt> will raise an exception if you're configured to listen for more than 1 queue
      class SingleFetchingStrategy
